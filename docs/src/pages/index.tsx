...
import { Terminal, Smartphone, Monitor, Globe, Zap, Code2, Rocket, Download, CheckCircle2, Book, Package, Play, Settings } from 'lucide-react';
...
export default function JetStartLanding() {
  ...
  return (
    <div className="min-h-screen overflow-hidden" style={{ backgroundColor: colors.bgColor, color: colors.textColor }}>
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 border-b backdrop-blur-xl" style={{ 
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            >
              <div className="w-7 h-7 rounded-md flex items-center justify-center" style={{ backgroundColor: colors.primary }}>
                <Zap className="w-4 h-4" style={{ color: colors.bgColor }} />
              </div>
              <span className="font-semibold text-lg">JetStart</span>
            </motion.div>
            
            <div className="hidden md:flex items-center gap-8">
              <a href="/docs/getting-started/introduction" className="text-sm text-gray-400 hover:text-white transition-colors">
                Docs
              </a>
              <a href="/blog" className="text-sm text-gray-400 hover:text-white transition-colors">
                Blog
              </a>
              <a href="https://github.com/dev-phantom/jetstart" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-white transition-colors">
                GitHub
              </a>
              <motion.button 
          ...
          >
            ...
            >
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                <path d="M20 0L21.8 18.2L40 20L21.8 21.8L20 40L18.2 21.8L0 20L18.2 18.2L20 0Z" fill={colors.primary} opacity="0.6"/>
              </svg>
            </motion.div>
          </motion.div>
        </div>
            ...
            {[
              {
                step: '01',
                title: 'Install CLI',
                description: 'Single command installation via npm. No complex setup or configuration required.',
                tech: ['npm', 'CLI'],
              ...
              },
              {
                ...
                description: 'Launch dev server and see changes instantly on mobile, desktop, or web.',
              ...
              >
                <div>
                  ...
                  <p className="text-gray-400 mb-6 leading-relaxed">
                    Scan a QR code and instantly stream your app to your phone. Like Expo Go, but for native Android with Kotlin & Compose.
                  </p>
                  <div className="space-y-3">
                    {['QR code instant setup', 'Live WebSocket streaming', 'Zero rebuild cycles'].map((item, i) => (
                      <motion.div 
                        key={i} 
                ...
                >
                  <div className="w-48 h-96 rounded-3xl border-4 flex items-center justify-center relative overflow-hidden" style={{ 
                    borderColor: colors.primary + '40',
            ...
            {activeTab === 1 && (
              ...
              >
                <div>
                  ...
                  <p className="text-gray-400 mb-6 leading-relaxed">
                    Full Android emulator environment. Test hardware features, system APIs, and real device behavior on your machine.
                  </p>
                  <div className="space-y-3">
                    {['AVD compatible', 'Hardware simulation', 'System-level testing'].map((item, i) => (
                      <motion.div 
                        key={i} 
                        className="flex items-center gap-3"
                        initial={{ opacity: 0, x: -20 }}
                ...
                <motion.div 
                  ...
                  transition={{ duration: 3, repeat: Infinity }}
                >
                  <div className="w-64 h-56 rounded-xl border-2 flex items-center justify-center relative overflow-hidden" style={{ 
                    borderColor: colors.primary + '40',
                    backgroundColor: colors.bgColor
                  }}>
            ...
            {activeTab === 2 && (
              ...
              >
                <div>
                  ...
                  <p className="text-gray-400 mb-6 leading-relaxed">
                    Preview your Android app directly in the browser. No SDK, no setup—just instant feedback for rapid prototyping.
                  </p>
                  <div className="space-y-3">
                    {['Zero installation', 'Browser-based preview', 'Shareable demo links'].map((item, i) => (
                      <motion.div 
                        key={i} 
                        className="flex items-center gap-3"
                        initial={{ opacity: 0, x: -20 }}
                ...
                <motion.div 
                  ...
                  transition={{ duration: 3, repeat: Infinity }}
                >
                  <div className="w-full h-48 rounded-xl border-2 flex items-center justify-center relative overflow-hidden" style={{ 
                    borderColor: colors.primary + '40',
                    backgroundColor: colors.bgColor
                  }}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <motion.div 
                    ...
                    transition={{ delay: i * 0.1 }}
                  >
                    <div className="w-1.5 h-1.5 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: colors.orange }} />
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <a href="/docs/getting-started/introduction" className="block text-gray-200 hover:text-white transition">Getting Started</a>
                <a href="/docs/cli/overview" className="block text-gray-200 hover:text-white transition">CLI Reference</a>
                <a href="/docs/architecture/overview" className="block text-gray-200 hover:text-white transition">Architecture</a>
              </div>
            </div>
            <div>
              <h3 className="font-semibold mb-3 text-sm">Community</h3>
              <div className="space-y-2 text-sm">
                <a href="https://github.com/dev-phantom/jetstart/discussions" target="_blank" rel="noopener noreferrer" className="block text-gray-200 hover:text-white transition">Discussions</a>
                <a href="https://github.com/dev-phantom/jetstart/issues" target="_blank" rel="noopener noreferrer" className="block text-gray-200 hover:text-white transition">Issues</a>
              </div>
            </div>
            <div>
              <h3 className="font-semibold mb-3 text-sm">More</h3>
              <div className="space-y-2 text-sm">
                <a href="/blog" className="block text-gray-200 hover:text-white transition">Blog</a>
                <a href="https://www.npmjs.com/package/@jetstart/cli" target="_blank" rel="noopener noreferrer" className="block text-gray-200 hover:text-white transition">npm</a>
                <a href="/docs/contributing/getting-started" className="block text-gray-200 hover:text-white transition">Contributing</a>
              </div>
            </div>
          </div>
          <div className="pt-8 border-t text-center text-sm text-gray-200" style={{ borderColor: 'rgba(255, 255, 255, 0.08)' }}>
